  ...
  return (
    <div className='p-4'>
      ...
      <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
        <div className='my-4'>
          <label htmlFor="author" className='text-xl mr-4 text-gray-500'>Title</label>
          <input type="text" 
          value={title} 
        ...
        <button onClick={handleSaveBook} className='bg-sky-500 text-white px-4 py-2 rounded-md'>Save Book</button>
